...
Click the button at the bottom right to change the language, [EN] is English, [CH] is Chinese. It only runs on Windows, If fails, download and install VC_redist.
